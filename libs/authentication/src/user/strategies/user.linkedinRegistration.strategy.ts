...
@Injectable()
export class LinkedInRegistrationStrategy extends PassportStrategy(
  Strategy,
  ...
  constructor(
    ...
    super(authService.getLinkedInRegisterConfig());
  }
  ...
  /**
   * Validates the LinkedIn registration strategy.
